...
poiClassRanks   = { school=1, university=1, kindergarten=1, college=1, park=1, campsite=1, cemetery=1,
					hospital=2, railway=2, bus=3, attraction=4, harbor=5, stadium=8, zoo=9, town_hall=10,
					library=14, police=15, post=16, golf=17, shop=18, grocery=19,
